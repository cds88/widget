...
*/
export const ShouldAwaitForControlsToShowTestCase: E2ETestDescription<FunctionalE2ETestsEnum> = {
    testCaseKey: FunctionalE2ETestsEnum.SHOULD_AWAIT_FOR_INDICATORS_TO_SHOW,
    label: 'Should await before spinner dissabpears and correctly show results at initial load',
