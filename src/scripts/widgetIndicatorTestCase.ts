...
const expectedColorsArrays = {
    ...
    '<40': [ ...Array(1).fill(enabledStripeColor),  ...Array(4).fill(disabledStripeColor)],
    '<60':[ ...Array(2).fill(enabledStripeColor),  ...Array(3).fill(disabledStripeColor)],
    '<80': [...Array(3).fill(enabledStripeColor),  ...Array(2).fill(disabledStripeColor)],
    '<100': [...Array(4).fill(enabledStripeColor),  ...Array(1).fill(disabledStripeColor)],
...
const arr: [number, string[]][] = Array.from({length:103}, (_, index)=>index-1).map( percentage=>[
    percentage, calculateExpectedResult(percentage)
